...
def _deploy_call_ratio(state, atm, expiry, client):
    ...
    multi_legs = [
        ...
        {"offset": "OTM14", "option_type": "CE", "action": "BUY", "quantity": LOT_SIZE*2, "product": PRODUCT},
        {"offset": "OTM6", "option_type": "CE", "action": "SELL", "quantity": LOT_SIZE * 3, "product": PRODUCT},
    ]
