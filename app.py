...
from blueprints.nifty_master_api import nifty_master_bp  # Import the Nifty Master API blueprint
...
def create_app():
    ...
    app.register_blueprint(nifty_master_bp)  # Register Nifty Master API blueprint
